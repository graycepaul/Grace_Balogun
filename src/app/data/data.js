...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Advanced analytics dashboard for food delivery platform with real-time metrics visualization, order tracking, and business intelligence insights.",
    image: "/projects/goodfood.jpg",
    technologies: [
      "React",
      "Chart.js",
      "Material-UI",
    ...
    links: {
      live: "https://goodfood-dashboard-nine.vercel.app/",
      github: "https://github.com/gravcepaul/goodfood-dashboard",
    },
    achievements: [
      "Figma Design in tegration",
  ...
  },
  {
    title: "Culina Vert",
    description:
      "Modern recipe discovery platform with AI-powered meal recommendations, dietary filtering, and interactive cooking instructions.",
    image: "/projects/culina.jpg",
    technologies: ["Next.js", "Tailwind CSS", "supabase", "Recipe API"],
    links: {
      live: "https://culina-vert.vercel.app/",
      github: "https://github.com/gravcepaul/culina-vert",
    },
    achievements: [
      "AI-powered recipe recommendations",
      "Advanced dietary filters",
      "Step-by-step cooking guide",
      "User recipe collection system",
...
export const techMapping = {
  React: {
    ...
    lightClass: "bg-green-50 border border-green-600 text-green-800",
    darkClass: "bg-amber-900/30 border border-amber-500 text-amber-400",
  },
  "Next.js": {
    label: "Next.js",
    keywords: ["Next.js", "next", "NextJS"],
    lightClass: "bg-black text-white",
    darkClass: "bg-gray-700 text-white",
  },
  TypeScript: {
    label: "TypeScript",
    keywords: ["TypeScript", "Typescript", "TS"],
    lightClass: "bg-green-800 text-white",
    darkClass: "bg-amber-700 text-white",
  },
  Firebase: {
    label: "Firebase",
    keywords: ["Firebase", "firebase"],
    lightClass: "bg-orange-100 text-orange-600",
    darkClass: "bg-orange-900/30 text-orange-400 border border-orange-500",
  },
  // Add more technologies here
  Node: {
    label: "Node.js",
    keywords: ["Node", "node", "Node.js", "Express"],
    lightClass: "bg-green-100 text-green-800 border border-green-300",
    darkClass: "bg-emerald-900/30 text-emerald-400 border border-emerald-500",
  },
  Tailwind: {
    label: "Tailwind CSS",
    keywords: ["Tailwind", "tailwind", "Tailwind CSS"],
    lightClass: "bg-cyan-50 text-cyan-700 border border-cyan-300",
    darkClass: "bg-cyan-900/30 text-cyan-400 border border-cyan-500",
  },
};
